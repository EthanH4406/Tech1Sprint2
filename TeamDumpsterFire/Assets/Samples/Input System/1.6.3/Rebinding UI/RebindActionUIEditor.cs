...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    {
        RebindActionUI m_ActionUI;


        protected void OnEnable()
        {
            m_ActionUI = (RebindActionUI)target;
        ...
        public override void OnInspectorGUI()
        {
			...
			using (new EditorGUI.IndentLevelScope())
			{
                ...
                if(m_ActionUI.m_OverRideActionLabel)
                {
        ...
        private GUIContent m_CustomizedUILabel = new GUIContent("Action Label");
